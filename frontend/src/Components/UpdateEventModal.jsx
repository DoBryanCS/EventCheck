...
export default function UpdateEventModal(props) {
  ...
  useEffect(() => {
    if (
      Object.keys(EventDataToUpdate).length >= 7 &&
      titleFocus &&
      descriptionFocus &&
      dateFocus &&
      timeFocus &&
      ...
      uploadTask.on(
        ...
        () => {
          ...
          getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
            setEventDataToUpdate((prev) => ({ ...prev, img: downloadURL }));
          });
        }
      );
    };
              ...
              <div key={input.id} className="field">
                ...
                >
                  <input
                    ...
                    value={EventDataToUpdate[input.id]}
